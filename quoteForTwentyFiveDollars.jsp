		    	...
		    	<form action="" id="original-quote-form" name="originalQuoteForm">
		            ...
		            <div class="row">
		                ...
		                <div class="comparison trans-america">
		                    <h5 class="rate-name">Compare to <span class="currency">$</span><span class="standard-coverage">425,000</span> <span class="rate-name">Standard Non-Smoker</span></h5>
		                </div>
		                <div class="row recommended-coverage">
		                    <div class="text-center col-md-6">
	                            <h4>Monthly Premium</h4>
	                            <h3 class="best-premium">$58/MO</h3>
	                        </div>
		                    <div class="text-center col-md-6">
	                            <h4>Term Period</h4>
		        ...
		        <form action="" id="comparison-quote-form" name="comparisonQuoteForm">
		            ...
		            <div class="row">
		                <div class="column">
		                    ...
		                    <p>Monthly Premium: <span class="best-premium">$58</span><span class="freq">/mo</span></p>
		                ...
		                <div class="column">
		                    ...
		                    <div class="comparison protective-life">
		                        <h5 class="rate-name">Compare to <span class="standard-coverage">$52</span>/mo</h5>
		                    </div>
		                </div>
		            </div>
		            <div class="row">
