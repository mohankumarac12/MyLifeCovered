        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="calculator.do" id="how_much_do_i_need" class="btn btn-primary margin-top-s" wpvalue="find_your_low_rate" onclick="quoteVisiblity('howMuchDoINeed')">How much do I need?</a>
					 <a href="quote.do" id="i_know_what_i_need" class="btn btn-primary margin-top-s"  onclick="quoteVisiblity('iKnowWhatINeed')">I know what I need</a>
                </div>
            </div>
            <!--</br>
            <div class="row">
