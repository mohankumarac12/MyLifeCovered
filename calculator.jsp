...
<html class="no-js" lang="">
    ...
    <section class="quote-tabs">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <a href="quote-form.do" class="tab">Quick Facts</a>
        ...
        <section id="calculator-report" class="quote" style="display:none">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form action="" id="needs-calculator-demographics-form" name="needsCalculatorDemographicsForm">
                            ...
                            <div class="inline-text required">
                                <input required="" class=" " pattern="[0-9]*" type="text" id="calc-annual-income" name="annual-income" maxlength="25">
                            ...
                            <div class="inline-select required ">
                             ...
                             <div class="inline-select required complete">
                                <input required="" class=" " pattern="[0-9]*" type="text" id="calc-coverage" name="coverage" maxlength="25">
              ...
              <!--               <div class="inline-select required complete">
                            ...
                            <div class="text-center">
                                <input type="button" class="btn btn-primary" value="See Your Quote" id="quote-form-submit" wpvalue="next" onclick="validateQuote('howMuchDoINeed')">
                            </div>
...
<div id="quote_recommended" class="background-wrap" style="display:none">
	<section id="quote-page" class="cover main-section" style="display:none">
	    ...
	    <div class="container">
		    	...
		    	<form action="" id="original-quote-form" name="originalQuoteForm">
		            ...
		            <div class="row">
		                <div class="best-class trans-america">
		                    ...
		                    <span class="best-premium">58</span>
		                ...
		                <div class="comparison trans-america">
		                    <h5 class="rate-name">Compare to <span class="currency">$</span><span class="price standerd-premium">52</span><span class="freq">/mo</span> <span class="rate-name">Standard Non-Smoker</span></h5>
		                </div>
		        ...
		        <form action="" id="comparison-quote-form" name="comparisonQuoteForm">
		            ...
		            <div class="row">
		                <div class="column">
		                    ...
		                    <p>Coverage: <span class="calculated-coverage">$700,000</span></p>
		                    <p>Term: <span class="term calculated-term">10 years</span></p>
		                    <p>Call <a href="tel:18555433630">${phoneNumber}</a></p>
		                </div>
		                <div class="column">
		                    <div class="multicarrier-class protective-life">
		                        <span class="currency">$</span>
			                    <span class="best-premium">52</span>
			                    <span class="freq">/mo</span>
		                    </div>
		                    <div class="comparison protective-life">
		                        <h5 class="rate-name">Compare to <span class="currency">$</span><span class="standerd-premium">52</span>/mo</h5>
		                    </div>
		                </div>
		            </div>
		            <div class="row">
		                ...
		                <div class="column">
		                    <div class="multicarrier-class banner-life">
		                        <span class="currency">$</span>
			                    <span class="best-premium">56</span>
			                    <span class="freq">/mo</span>
		                    </div>
		            ...
		            <div class="row">
		                ...
		                <div class="column">
		                    <div class="multicarrier-class aig-life">
		                        <span class="currency">$</span>
			                    <span class="best-premium">61</span>
			                    <span class="freq">/mo</span>
		                    </div>
		            ...
		            <div class="row">
		                ...
		                <div class="column">
		                    <div class="multicarrier-class lincoln-life">
		                        <span class="currency">$</span>
			                    <span class="best-premium">59</span>
			                    <span class="freq">/mo</span>
		                    </div>
		    ...
		    <div id="legal_policy">
		    	<a href="legalInformation.do">Legal Policy <i class="fa fa-angle-right" aria-hidden="true"></i></a>
		    </div>
	    </div>
	</section>
	<section id="range_sliders">
	    <div class="sliders">
	        ...
	        <span class="quote-coverage calculated-coverage">$700,000</span>
